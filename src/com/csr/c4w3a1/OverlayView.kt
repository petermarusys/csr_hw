...
class OverlayView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    private var results: MutableList<DetectionResult> = ArrayList<DetectionResult>()
    ...
    fun setResults(results: MutableList<DetectionResult?>?) {
        this.results = (if (results != null) results else ArrayList<DetectionResult>()) as MutableList<DetectionResult>
        invalidate()
    }
